...
{
	PIEaddInputSlider("Mass of box",1,handleMass,1,8,1);
	//PIEaddInputSlider("Force from right",3,handleRight,1,5,1);
	//PIEaddInputSlider("Force from left",2,handleLeft,1,5,1);
	PIEaddInputSlider("Position",0,handleDistance,-3,3,0.5);
}
var size;
function handleMass(newValue)
{
	resetExperiment();
	mass=newValue;
	PIEremoveElement(box);
    size=1+mass/10;
	geometry=new THREE.BoxGeometry(size, 1,size);
    material=new THREE.MeshPhongMaterial({color:"#873600"});
    ...
    box.add(line);
    box.rotation.x+=Math.PI/10;
    PIErender();
    
    var loader=new THREE.FontLoader();
    font=loader.parse(fontJSON);
    text=new THREE.Mesh(new THREE.TextGeometry(""+mass+"kg",{font:font,size:1/3,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"black"  }));
    PIEaddElement(text);
    box.add(text);
    text.position.set(-0.4,0,mass/10+0.5);
    box.position.set(pos,0.3,2);
    PIErender();
...
/*function handleRight(newValue)
{
	...
	text2=new THREE.Mesh(new THREE.TextGeometry(""+ForceR+" N",{font:font,size:1/3,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"black"  }));
    PIEaddElement(text2);
    text2.position.set(-10.3,-3.2,1);
    PIErender();

    if(ForceR>ForceL)
	{   
	    text5=new THREE.Mesh(new THREE.TextGeometry(""+(ForceR-ForceL)+" N",{font:font,size:1/3,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"blue"  }));
	    PIEaddElement(text5);
	    text5.position.set(-0.5,3.8,0);
	}

	if(ForceL>ForceR)
	{
		text5=new THREE.Mesh(new THREE.TextGeometry(""+(ForceL-ForceR)+" N",{font:font,size:1/3,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"blue"  }));
	    PIEaddElement(text5);
	    text5.position.set(-0.5,3.8,0);
	}
...
/*function handleLeft(newValue)
{
	...
	text1=new THREE.Mesh(new THREE.TextGeometry(""+ForceL+" N",{font:font,size:1/3,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"black"  }));
    PIEaddElement(text1);
    text1.position.set(9.5,-3.2,1);
    PIErender();
...
function handleDistance(newValue)
{
	resetExperiment();
	pos=newValue;
	box.position.set(pos,0.3,2);
...
function addRight()
{
    ...
    geometry=new THREE.CylinderGeometry(0.32,0.32,0.5);
    material=new THREE.MeshBasicMaterial({color:"yellow"});
    r1=new THREE.Mesh(geometry,material);
    PIEaddElement(r1);

    text10=new THREE.Mesh(new THREE.TextGeometry("1kg",{font:font,size:1/4,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"red"  }));
    PIEaddElement(text10);
    text10.position.set(-0.4,-0.1,0.3);
    r1.add(text10);
    
    r1.position.set(11,-2,0);

    geometry=new THREE.CylinderGeometry(0.35,0.35,0.5);
    material=new THREE.MeshBasicMaterial({color:"yellow"});
    r2=new THREE.Mesh(geometry,material);
    PIEaddElement(r2);

    text10=new THREE.Mesh(new THREE.TextGeometry("2kg",{font:font,size:1/4,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"red"  }));
    PIEaddElement(text10);
    text10.position.set(-0.4,0,0.4);
    r2.add(text10);
    
    r2.position.set(11,-3,0);

    geometry=new THREE.CylinderGeometry(0.38,0.38,0.5);
    material=new THREE.MeshBasicMaterial({color:"yellow"});
    r3=new THREE.Mesh(geometry,material);
    PIEaddElement(r3);

    text10=new THREE.Mesh(new THREE.TextGeometry("3kg",{font:font,size:1/4,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"red"  }));
    PIEaddElement(text10);
    text10.position.set(-0.4,0,0.4);
    r3.add(text10);
    
    r3.position.set(11,-4,0);

    geometry=new THREE.CylinderGeometry(0.41,0.41,0.5);
    material=new THREE.MeshBasicMaterial({color:"yellow"});
    r4=new THREE.Mesh(geometry,material);
    PIEaddElement(r4);

    text10=new THREE.Mesh(new THREE.TextGeometry("4kg",{font:font,size:1/4,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"red"  }));
    PIEaddElement(text10);
    text10.position.set(-0.4,0,0.4);
    r4.add(text10);
    
    r4.position.set(11,-5,0);

    geometry=new THREE.CylinderGeometry(0.44,0.44,0.5);
    material=new THREE.MeshBasicMaterial({color:"yellow"});
    r5=new THREE.Mesh(geometry,material);
    PIEaddElement(r5);

    text10=new THREE.Mesh(new THREE.TextGeometry("5kg",{font:font,size:1/4,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"red"  }));
    PIEaddElement(text10);
    text10.position.set(-0.4,0,0.42);
    r5.add(text10);
    
    r5.position.set(11,-6,0);
...
function addLeft()
{
    ...
    text10=new THREE.Mesh(new THREE.TextGeometry("1kg",{font:font,size:1/4,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"red"  }));
    PIEaddElement(text10);
    text10.position.set(-0.2,-0.1,0.3);
    l1.add(text10);
    
    l1.position.set(-11,-2,0);
    ...
    l4.position.set(-11,-5,0);

    geometry=new THREE.CylinderGeometry(0.44,0.44,0.5);
    material=new THREE.MeshBasicMaterial({color:"yellow"});
    l5=new THREE.Mesh(geometry,material);
    PIEaddElement(l5);

    text10=new THREE.Mesh(new THREE.TextGeometry("5kg",{font:font,size:1/4,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"red"  }));
    PIEaddElement(text10);
    text10.position.set(-0.2,0,0.42);
    l5.add(text10);
    
    l5.position.set(-11,-6,0);
...
function loadExperimentElements()
{
    ...
    tex.load("floor1.jpg", function(texture){
    	geometry=new THREE.BoxGeometry(12, 0.5, 8);
        ...
        geometry=new THREE.BoxGeometry(0.5, 5, .5);
        material=new THREE.MeshPhongMaterial({map:texture});
        mesh=new THREE.Mesh(geometry,material);
        PIEaddElement(mesh);
       	mesh.rotation.x+=Math.PI/10;
        mesh.position.set(5,-3,1.7);
        PIErender();
    ...
    PIEaddElement(text);
    box.add(text);
    text.position.set(-0.4,0,0.1+0.5);
    box.position.set(pos,0.3,2);

        
    geometry=new THREE.BoxGeometry(14, 0.1,0.5);
    material=new THREE.MeshPhongMaterial({color:"white"});
    rope=new THREE.Mesh(geometry,material);
    PIEaddElement(rope);
    rope.position.set(0,0.3,2);
	...
	PIEaddElement(torus);
	torus.position.set(7.0,-0.1,2.2);
	geometry = new THREE.TorusGeometry( 0.4, 0.2, 16, 100 );
	material = new THREE.MeshBasicMaterial( { color: "blue" } );
	torus = new THREE.Mesh( geometry, material );
	PIEaddElement(torus);
	torus.position.set(7.0,-0.1,1.8);
    ...
    geometry=new THREE.BoxGeometry(0.1,9,0.05);
    material=new THREE.MeshPhongMaterial({color:"white"});
    rope1=new THREE.Mesh(geometry,material);

    PIEaddElement(rope1);
    rope1.position.set(7.4,0,2);

    

    geometry=new THREE.BoxGeometry(0.1,8,0.05);
    material=new THREE.MeshBasicMaterial({color:"black"});
    rope=new THREE.Mesh(geometry,material);
    PIEaddElement(rope);
    rope.position.set(7.4,4,2);

    geometry=new THREE.BoxGeometry(0.1,9,0.05);
    material=new THREE.MeshPhongMaterial({color:"white"});
    rope2=new THREE.Mesh(geometry,material);
    
    PIEaddElement(rope2);
    rope2.position.set(-7.4,0,2);
    ...
    var header=["Sr.No.  ","Net Force     |   " ,"    Velocity", "Time"];
    ...
    dir1 = new THREE.ArrowHelper( dir, origin, length, "blue",0.2,0.5 );
    dir1.rotation.z-=Math.PI/2;
    dir1.position.set(0,3,0);
    PIEaddElement(dir1);
    
    dir2 = new THREE.ArrowHelper( dir, origin, length, "red",0.2,0.5 );
    dir2.rotation.z+=Math.PI/2;
    dir2.position.set(0,3,0);
    PIEaddElement(dir2);
    ...
    dir3 = new THREE.ArrowHelper( dir, origin, length, "#800080",0.2,0.2 );
    dir3.rotation.z-=Math.PI/2;
    dir3.position.set(-8.5,-2,0);
    dir3.rotation.z+=Math.PI/2;
    PIEaddElement(dir3);
    

    dir4 = new THREE.ArrowHelper( dir, origin, length, "#800080",0.2,0.2 );
    dir4.rotation.z-=Math.PI/2;
    dir4.position.set(8.5,-2,0);
    dir4.rotation.z+=Math.PI/2;
    PIEaddElement(dir4);
    ...
    /*geometry=new THREE.PlaneGeometry(2,1,1,1);
    material=new THREE.MeshPhongMaterial({color:"yellow"});
    Field2=new THREE.Mesh(geometry,material);
    PIEaddElement(Field2);
    Field2.position.set(10,-3,1);*/
    ...
    geometry=new THREE.PlaneGeometry(2,0.5,1,1);
    material=new THREE.MeshPhongMaterial({color:"yellow"});
    Field3=new THREE.Mesh(geometry,material);
    PIEaddElement(Field3);
    Field3.position.set(0,4,0);
    geometry=new THREE.PlaneGeometry(5,0.5,1,1);
    material=new THREE.MeshPhongMaterial({color:"gray"});
    Field4=new THREE.Mesh(geometry,material);
    PIEaddElement(Field4);
    Field4.position.set(0,3.5,0);
	text6=new THREE.Mesh(new THREE.TextGeometry("Resultant Force",{font:font,size:1/3,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"black"  }));
	PIEaddElement(text6);
	text6.position.set(-1.5,3.3,0);
    ...
    text500=new THREE.Mesh(new THREE.TextGeometry("Choose mass from right and left side by clicking",{font:font,size:1/3,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"red"  }));
    PIEaddElement(text500);
    text500.position.set(-5,-5,2);

    geometry=new THREE.PlaneGeometry(2,5);
    material=new THREE.MeshBasicMaterial({color:"black"});
    black1=new THREE.Mesh(geometry,material);
    PIEaddElement(black1);
    black1.position.set(-9,-3,4);

    black2=new THREE.Mesh(geometry,material);
    PIEaddElement(black2);
    black2.position.set(9,-3,4);

    PIEremoveElement(black1);
    PIEremoveElement(black2);
    ...
    PIEaddInputCommand("Quiz me",Quiz);

    //PIEaddInputCommand("Next Question",Quiz);
...
function R1()
{
    ...
    addLeft();
    ForceL=1;
    PIEremoveElement(rope1)
    geometry=new THREE.BoxGeometry(0.1,9,0.05);
    material=new THREE.MeshPhongMaterial({color:"white"});
    rope1=new THREE.Mesh(geometry,material);
    r1.position.set(0,-4.75,0);
    PIEaddElement(rope1);
    rope1.add(r1);
    rope1.position.set(7.4,0,2);
...
function L1()
{
    ...
    addLeft();
    ForceR=1;
    PIEremoveElement(rope2)
    geometry=new THREE.BoxGeometry(0.1,9,0.05);
    material=new THREE.MeshPhongMaterial({color:"white"});
    rope2=new THREE.Mesh(geometry,material);
    l1.position.set(0,-4.75,0);
    PIEaddElement(rope2);
    rope2.add(l1);
    rope2.position.set(-7.4,0,2);
...
function Learning()
{
    ...
    PIEaddElement(box1);
    //
    box1.rotation.x+=Math.PI/10;
    
    box1.position.set(-12,3,2);


	var dir = new THREE.Vector3( 1,0, 0 );
    dir.normalize();

    var origin = new THREE.Vector3( -12, 3, 2 );
    var length = 1.5;
    //var hex = "black";
    dir5 = new THREE.ArrowHelper( dir, origin, length, "#800080",0.2,0.2 );
    PIEaddElement(dir5);
    ...
    var length = 1.5;
    //var hex = "black";
    dir6 = new THREE.ArrowHelper( dir, origin, length, "#800080",0.2,0.2 );
    PIEaddElement(dir6);
    ...
    var length = 1.5;
    //var hex = "black";
    dir7 = new THREE.ArrowHelper( dir, origin, length, "#800080",0.2,0.2 );
    PIEaddElement(dir7);
    ...
    var length = 1.5;
    //var hex = "black";
    dir8 = new THREE.ArrowHelper( dir, origin, length, "#800080",0.2,0.2 );
    PIEaddElement(dir8);*/
    

    //Quiz();
    p1=0;p2=0;
	rope2.position.set(7.4,p1,2);
	rope1.position.set(-7.4,p2,2);
	...
	PIEremoveElement(text21);
	PIEremoveElement(text11);
	PIEremoveElement(text12);
	PIEremoveElement(text13);
	PIEremoveElement(text14);
	PIEremoveElement(text15);
	PIEremoveElement(text41);
	PIEremoveElement(text16);
	PIEremoveElement(Field1);
	flag100=1;
	x=0;
	...
	var loader=new THREE.FontLoader();
	font=loader.parse(fontJSON);
	/*text41=new THREE.Mesh(new THREE.TextGeometry("Click white circle to answer",{font:font,size:1/3,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"green"  }));
	PIEaddElement(text41);
	text41.position.set(-3,-5,2.1);




	box.position.set(x,0.3,2);
	PIEremoveElement(button);
    ...
    PIEresetClick(button);
    button.position.set(0,-4,2);*/
    //choice=1;
	a=1+Math.floor((Math.random()*20))%5;
	m=1+Math.floor((Math.random()*20))%10;
	f=m*a;
	s=5.8;
	u1=1+Math.floor((Math.random()*20))%2;
	v=Math.sqrt(u*u+2*a*s);
	u=u1*(-1);
	t=(v-u1)/a;	
	var choice=1+Math.floor((Math.random()*20))%4;
	if(choice==1)
	{
		//alert(v);
		//PIEsetClick(button,velocity);
		
		text11=new THREE.Mesh(new THREE.TextGeometry("Find Final Velocity",{font:font,size:1/2,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"red"  }));
	    text12=new THREE.Mesh(new THREE.TextGeometry("Initial Velocity:"+u1,{font:font,size:1/3,height:0.01,material:0}),new THREE.MeshBasicMaterial({color:"white"  }));
	    text13=new THREE.Mesh(new THREE.TextGeometry("Force:"+f,{font:font,size:1/3,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"white"  }));
	    text14=new THREE.Mesh(new THREE.TextGeometry("Mass:"+m,{font:font,size:1/3,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"white"  }));
	    text15=new THREE.Mesh(new THREE.TextGeometry("Total time"+t.toFixed(2),{font:font,size:1/3,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"white"  }));
	    text16=new THREE.Mesh(new THREE.TextGeometry("Final Velocity:"+v.toFixed(2),{font:font,size:1,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"green"  }));
	...
	if(choice==2)
	{
		//PIEsetClick(button,setmass);
		
		text11=new THREE.Mesh(new THREE.TextGeometry("    Find Mass",{font:font,size:1/2,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"red"  }));
	    text12=new THREE.Mesh(new THREE.TextGeometry("Initial Velocity:"+u1,{font:font,size:1/3,height:0.01,material:0}),new THREE.MeshBasicMaterial({color:"white"  }));
	    text13=new THREE.Mesh(new THREE.TextGeometry("Force:"+f,{font:font,size:1/3,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"white"  }));
	    text14=new THREE.Mesh(new THREE.TextGeometry("Final velocity:"+v.toFixed(2),{font:font,size:1/3,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"white"  }));
	    text15=new THREE.Mesh(new THREE.TextGeometry("Total time:"+t.toFixed(2),{font:font,size:1/3,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"white"  }));
	    text16=new THREE.Mesh(new THREE.TextGeometry("Mass is:"+m.toFixed(2),{font:font,size:1,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"green"  }));
	...
	if(choice==3)
	{
		//PIEsetClick(button,Total_Time);
		
		text11=new THREE.Mesh(new THREE.TextGeometry("Find Total Time",{font:font,size:1/2,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"red"  }));
	    text12=new THREE.Mesh(new THREE.TextGeometry("Initial Velocity:"+u1,{font:font,size:1/3,height:0.01,material:0}),new THREE.MeshBasicMaterial({color:"white"  }));
	    text13=new THREE.Mesh(new THREE.TextGeometry("Force:"+f,{font:font,size:1/3,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"white"  }));
	    text14=new THREE.Mesh(new THREE.TextGeometry("Mass:"+m,{font:font,size:1/3,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"white"  }));
	    text15=new THREE.Mesh(new THREE.TextGeometry("Final Velocity:"+v.toFixed(2),{font:font,size:1/3,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"white"  }));
	    text15=new THREE.Mesh(new THREE.TextGeometry("Total time is:"+t.toFixed(2),{font:font,size:1,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"green"  }));
	...
	if(choice==4)
	{
		//PIEsetClick(button,Force);
		
		text11=new THREE.Mesh(new THREE.TextGeometry("Find Net Force",{font:font,size:1/2,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"red"  }));
	    text12=new THREE.Mesh(new THREE.TextGeometry("Initial Velocity:"+u1,{font:font,size:1/3,height:0.01,material:0}),new THREE.MeshBasicMaterial({color:"white"  }));
	    text13=new THREE.Mesh(new THREE.TextGeometry("Final Velocity:"+f,{font:font,size:1/3,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"white"  }));
	    text14=new THREE.Mesh(new THREE.TextGeometry("Mass:"+m,{font:font,size:1/3,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"white"  }));
	    text15=new THREE.Mesh(new THREE.TextGeometry("Total time"+t.toFixed(2),{font:font,size:1/3,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"white"  }));
	    text16=new THREE.Mesh(new THREE.TextGeometry("Net Force"+f.toFixed(2),{font:font,size:1,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"green"  }));
	...
	//PIEaddElement(text11);
	PIErender();
	text11.position.set(-2,-3,0);
	text12.position.set(-7.5,2.5,0);
	text13.position.set(2,2.5,0);
	text14.position.set(6,2.5,0);
	text15.position.set(-3,2.5,0);
	text16.position.set(-4,5,2.1);
	/*if(choice==5)
	{
		text11=new THREE.Mesh(new THREE.TextGeometry("Find Final Velocity",{font:font,size:1/3,height:0.01,material:0}),new THREE.MeshLambertMaterial({color:"black"  }));
...
function velocity()
{
	...
	PIEremoveElement(text21);
	var ans=prompt("Enter Final Velocity upto two decimals")
	var loader=new THREE.FontLoader();
	font=loader.parse(fontJSON);
	if(ans<v+0.05 && ans> v-0.05)
		alert("Correct");
	else
		alert("Wrong");
...
function resetExperiment()
{
	...
	box.position.set(0,0.3,2);
	pos=PIEgetInputSlider("Position");
	time=0;
	box.add(text);
	PIEremoveElement(Field1);
	PIEremoveElement(text42);
	box.position.set(pos,0.3,2);
	u=0;
	p1=0;
	p2=0;
	rope1.position.set(7.4,p1,2);
	rope2.position.set(-7.4,p1,2);
	dir2.visible=false;
	dir1.visible=false;
	Field3.visible=true;
...
function updateExperimentElements(t,dt)
{
    ...
    {   
        ...
        PIEupdateTableCell(trials,1,ForceR-ForceL);*/
    }
    ...
    if(ForceL>ForceR)
    {
        ...
        text5.position.set(-0.5,3.8,0);
        /*PIEupdateTableCell(trials,0,trials);
        PIEupdateTableCell(trials,1,ForceL-ForceR);*/
    }
		...
		if(flag20==flag21)
	{
		...
		flag20++;
		//alert(flag20+" "+flag21);
		if(pos<=-5.7+mass/10 && ForceR>ForceL)
		{
			pos=-5.8+mass/10;
			alert("Box is already at fallen condition. Apply More Force at reverse direction" );
			flag21++;
			PIEstopAnimation();
		}
		if(pos>=5.8-mass/10 && ForceL>ForceR)
		{
			pos=5.8-mass/10;
			flag21++;
			alert("Box is already at fallen condition. Apply More Force at reverse direction" );
		...
		if(flag==1)
	{
		...
		if(ForceL<ForceR)
		{
			...
			time+=boundaryT;
			u+=boundaryT*(ForceR-ForceL)/mass;
			pos-=((u*boundaryT-0.5*boundaryT*boundaryT*(ForceR-ForceL)/mass));
			p1+=(((u*boundaryT-0.5*boundaryT*boundaryT*(ForceR-ForceL)/mass)))/2;
			p2-=(((u*boundaryT-0.5*boundaryT*boundaryT*(ForceR-ForceL)/mass)))/2
			rope1.position.set(7.4,p1,2);
			rope2.position.set(-7.4,p2,2);
		...
		if(ForceR==ForceL)
		{
            ...
            alert("Equal force from both side box will not move");
			flag21++;
            trials++;
            for(var i=1;i<=trials;i++)
            {
		...
		if(flag1%20==10)
		{
			dir1.position.set(2,3,0);
			dir2.position.set(-2,3,0);
			//flag1++;
		}
		...
		if(pos>=5.8-mass/10)
		{
		    ...
		    PIEremoveElement(text3);
		    PIEremoveElement(text4);
		    text3=new THREE.Mesh(new THREE.TextGeometry("Final Velocity:"+(-1*u).toFixed(2),{font:font,size:1/3,height:0.01,material:0}),new THREE.MeshBasicMaterial({color:"white"  }));
		    PIEaddElement(text3);
		    text3.position.set(-6,5,0.5);

		    text4=new THREE.Mesh(new THREE.TextGeometry("Time Taken:"+time.toFixed(2)+"seconds",{font:font,size:1/3,height:0.01,material:0}),new THREE.MeshBasicMaterial({color:"white"  }));
		    PIEaddElement(text4);
		    //PIEaddElement(text4);
		    text4.position.set(0,5,0.5);
            PIEupdateTableCell(trials,2,(u).toFixed(2));
            PIEupdateTableCell(trials,3,time.toFixed(2));
            trials++;
		...
		if(pos<=-5.8+mass/10)
		{
			...
			var loader=new THREE.FontLoader();
		    font=loader.parse(fontJSON);
		    text3=new THREE.Mesh(new THREE.TextGeometry("Final Velocity:"+u.toFixed(2),{font:font,size:1/3,height:0.01,material:0}),new THREE.MeshBasicMaterial({color:"white"  }));
		    PIEaddElement(text3);
		    text3.position.set(-6,5,0.5);
		...
		//rope2.position.y-=0.5;
		
		//text.position.set(-0.4+pos,0.3,2);
		flag1++;
	}
	flag=1;
	...
	if(flag100==1)
	{
		boundaryT=dt/1000;
		u-=boundaryT*a/m;
		x-=((u*boundaryT-0.5*boundaryT*boundaryT*a/m))*2;
		if(x<=-5.8)
		{
			x=-5.8;
			//PIEstopAnimation();
		...
		if(x!=5.8)
		{
			p1+=((u*boundaryT-0.5*boundaryT*boundaryT*a/m))/1.5;
			p2-=((u*boundaryT-0.5*boundaryT*boundaryT*a/m))/1.5;
			rope2.position.set(7.4,p1,2);
			rope1.position.set(-7.4,p2,2);
		}
		box.position.set(x,0.3,2);
...
{
    helpContent="";
    helpContent = helpContent + "<h2>Newtons 2nd Law help</h2>";
    helpContent = helpContent + "<h3>About the experiment</h3>";
    helpContent = helpContent + "<p>The acceleration of an object as produced by a net force is directly proportional to the magnitude of the net force, in the same direction as the net force, and inversely proportional to the mass of the object.</p>";
    helpContent = helpContent + "<p>F = ma</p>";
    helpContent = helpContent + "<h3>Animation control</h3>";
    helpContent = helpContent + "<p>The top line has animation controls. There are two states of the experiment.</p>";
    helpContent = helpContent + "<h3>The setup stage</h3>";
    helpContent = helpContent + "<p>You can control the following:</p>";
    helpContent = helpContent + "<ul>";
    helpContent = helpContent + "<li>You can choose the mass of the box</li>";
    helpContent = helpContent + "<li>You can choose Mass hanged in Right side </li>";
    helpContent = helpContent + "<li>You can change Mass hanged in Left side </li>";
    helpContent = helpContent + "<li>You can change postion of box</li>";
    helpContent = helpContent + "</ul>";
    helpContent = helpContent + "<p>Once you setup the experiment, you can enter the animation stage by clicking the start button</p>";
    helpContent = helpContent + "<h3>The animation stage</h3>";
    helpContent = helpContent + "<p>In the animation stage, box will move according to according to net force and friction is zero</p>";
    helpContent = helpContent + "<p>Formulae used are --></p>";
    helpContent = helpContent + "<p>1.F= ma</p>";
    helpContent = helpContent + "<p>2.v = u + at</p>";
    helpContent = helpContent + "</ul>";
...
{
    infoContent =  "";
    infoContent = infoContent + "<Newtons 2nd Law Information</h2>";
    infoContent = infoContent + "<h3>About the experiment</h3>";
    helpContent = helpContent + "<p>The acceleration of an object as produced by a net force is directly proportional to the magnitude of the net force, in the same direction as the net force, and inversely proportional to the mass of the object.</p>";
    
    infoContent = infoContent + "<p>Experiment shows change in velocity after constant force</p>";
    infoContent = infoContent + "<p>This follows the theorem that continuous force increases velocity continuosly</p>";
    infoContent = infoContent + "<p>Box will be stopped at falling poing</p>";
    infoContent = infoContent + "<p>Size of Box increases on incresing mass</p>";
    infoContent = infoContent + "<p>If equal force is applied from both side then no motion will occur</p>";
    infoContent = infoContent + "<p>Box will move in the direction where force is more</p>";
    infoContent = infoContent + "<h3>Learning Information</h3>";
    infoContent = infoContent + "<p>One of the value of Force,mass,initial velocity or final velocity will be missing and answer will be shown</p>";
    infoContent = infoContent + "<p>One of the value of Force,mass,initial velocity or final velocity will be missing and student will answer after using Formulae</p>";
    infoContent = infoContent + "<p>1.V=u + at</p>";
    infoContent = infoContent + "<p>2.F = ma</p>";
